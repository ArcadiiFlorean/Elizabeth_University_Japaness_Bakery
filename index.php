...
<main class="main">
    ...
    <?php foreach ($menu_items as $item): ?>
        <div class="menu-item" 
             onclick="openModal('<?php echo addslashes($item['name']); ?>', '<?php echo addslashes($item['description']); ?>', '<?php echo addslashes($item['price']); ?>', './admin/<?php echo htmlspecialchars($item['image']); ?>')"
...
<div id="myModal" class="modal">
    <div class="modal-content">
        ...
        <img id="modal-image" src="" alt="" style="width: 100%; border-radius: 10px;">
